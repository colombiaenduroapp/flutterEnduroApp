            ...
            children: [
              Row(
                ...
                children: [
                  ...
                  BotonGestionar().boton_gestionar(
                      Icons.event, 'Eventos', context, pages_listas_empresas()),
                ],
              ),
              Row(
                mainAxisAlignment: MainAxisAlignment.spaceAround,
                children: [
                  BotonGestionar().boton_gestionar(Icons.link,
                      'Publicacion Masivas', context, pages_listas_empresas()),
                  BotonGestionar().boton_gestionar(Icons.help_outline, 'Quejas',
